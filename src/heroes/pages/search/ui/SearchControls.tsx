...
export const SearchControls = () => {
    ...
    const activeAccordion = searhParams.get("active-accordion") ?? "";
    const selectedStrength = Number(searhParams.get("strength") ?? "0");
        ...
        <>
            <div className="flex flex-col lg:flex-row gap-4 mb-8">
                ...
                <div className="flex gap-2">
                    <Button
                        variant={
                            activeAccordion === "advance-filters"
                                ? "default"
                                : "outline"
                        }
                        className="h-12"
                        onClick={() => {
                            if (activeAccordion === "advance-filters") {
                                ...
                                // searhParams.delete("active-accordion");
                                return;
                            }
                            setQueryParams(
                                "active-accordion",
